...
* **ใช้  "LIFF sendMessages" หรือ "LIFF Client Message" * เท่านั้น ผ่าน LINE_LIFF_ID ที่กำหนดใน HTML
...
| `config.gs` | **ใช้ไฟล์ที่แนบมาให้ตามนี้เป๊ะ ๆ ห้ามแก้ไขค่าคงที่ใด ๆ ในไฟล์นี้ หากขาด Key ที่ต้องใช้เพิ่ม ให้เพิ่มเข้าไปในโครงสร้าง Object เดิม ห้ามสร้างไฟล์ Config ใหม่แยกต่างหาก** |
...
ที่มีอยู่แล้วในไฟล์นี้ หากต้องเพิ่ม Key ใหม่ เช่น LINE LIFF ID  ให้เพิ่มในโครงสร้าง
Object เดิมเท่านั้น  สำหรับค่า LINE LIFF ID ที่ใช้ ใน project นี้คือ "2009016720-0Df5GB2w" )  
...
4. ต้องส่ง  "LIFF sendMessages" หรือ "LIFF Client Message"  กลับไปสรุปข้อมูลที่บันทึกตามรูปแบบในข้อ 6 และห้ามทำให้ขั้นตอน
